...
const createMulterConfig = (destinationPath) => {
    return multer({
        ...
        fileFilter: (req, file, cb) => {
            ...
            else cb (new Error (`Solo se aceptan archivos de los siguientes tipos ${MIMETYPES.join(" ")}`))
        },
        limits:{
            fileSize: MAX_SIZE
        }
...
export const uploadPicture = createMulterConfig("../../public/uploads/pet-pictures")